...
export const heroContent = {
  title: '66% лікарів вже використовують ШІ. Ви — серед них?',
  subtitle:
...
export const painPoints: PainPoint[] = [
  ...
  },
  {
    ...
    text: 'Стандарти МОЗ оновлюються, гайдлайни змінюються ще частіше. Тримати все в голові неможливо.',
  },
  {
    id: 'pain-4',
    icon: 'search',
    headline: 'Складний випадок — а спитати нікого.',
    text: 'Сумніви в діагнозі, рідкісне призначення, нетипові симптоми. Дзвонити колегам — незручно, шукати в підручниках чи настановах МОЗ — довго. Пацієнт чекає.',
  },
];

export const painAccent = {
  text: 'Ви не маєте часу розбиратись з ШІ. І не повинні.',
  stat: 'Ми зібрали те, на що у вас пішли б тижні: правильні запити для ChatGPT, щоб він давав точні відповіді з джерелами — за хвилини замість годин.',
};
