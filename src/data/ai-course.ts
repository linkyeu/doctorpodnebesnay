...
export const whatsInsideTasks: WhatsInsideTask[] = [
  ...
  },
  {
    ...
    result: 'Як знайти актуальну рекомендацію МОЗ, CDC чи NICE через ШІ — за секунди',
  },
  {
    id: 'task-patients',
...
export const heroContent = {
  ...
  subtitle:
    'Структурований гайд для лікарів: правильні промпти, перевірка джерел, робота з клінічними рекомендаціями та доказовими джерелами через ШІ. <br>Від сумніву в дозуванні — до перевіреної відповіді за хвилину.',
...
export const pricingContent = {
  ...
  features: [
    ...
    'Щотижневий огляд оновлень — нові гайдлайни, зміни в рекомендаціях, апдейти у вашій сфері',
  ],
  cta: 'Отримати довідник — 799 ₴',
