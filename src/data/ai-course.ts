...
export const heroContent = {
  ...
  subtitle:
    'Готові рішення для ChatGPT — під щоденні задачі лікаря. Копіюєте — вставляєте — отримуєте точний результат. Без жодних IT-навичок.',
...
export const painAccent = {
  ...
  stat: 'Ми зібрали те, на що у вас пішли б тижні: як задавати ChatGPT правильні питання, щоб він не вигадував, давав точні відповіді з джерелами і робив за хвилини те, на що ви витрачаєте години.',
};
...
export const whyNotChatGptPoints: WhyNotPoint[] = [
  {
    ...
    text: 'Без правильного запиту ШІ ігнорує настанови МОЗ, не шукає в PubMed і відповідає «в середньому по лікарні». Наші рішення вже містять контекст: протоколи, актуальні джерела, структуру — щоб відповідь була клінічно точною.',
  },
  {
    id: 'why-2',
    icon: 'shield',
    title: 'Галюцинації ШІ — найбільший ризик',
    text: 'ChatGPT вигадує джерела, плутає дозування, видає застарілі дані. Кожне наше рішення має вбудовані чеклісти перевірки — ви точно знаєте, коли довіряти, а коли ні.',
  },
  {
    id: 'why-3',
    icon: 'zap',
    title: 'Формулювати запити — це окрема навичка',
    text: 'Правильний промпт для медичної задачі — це 100-200 слів зі структурою, контекстом і обмеженнями. Ми це вже зробили. Вам лишається скопіювати і вставити.',
  },
];
