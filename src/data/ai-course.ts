...
export const whatsInsideSubtitle = 'Рішення для задач, які забирають найбільше часу';
...
export const whatsInsideTasks: WhatsInsideTask[] = [
  ...
  },
  {
    ...
    result: 'Виписка за структурою вашої клініки — залишається перевірити',
  },
];
...
export const heroContent = {
  ...
  subtitle:
    'Від сумніву в дозуванні до перевіреної відповіді за хвилину. <br>Довідник покаже, як використовувати ШІ у лікарській практиці. <br>Покроково, без коду.',
  sourceNote: '*За даними AMA Physician Survey, США, 2024',
  productLine: 'PDF-ДОВІДНИК + ВІДЕО',
...
export const painPoints: PainPoint[] = [
  {
    ...
    text: '6 років теорії — а реальний пацієнт не схожий на підручник. Нечіткі симптоми, тиск часу, наставника поруч нема.',
  },
  {
    id: 'pain-2',
    icon: 'alert',
    headline: 'Діагноз є — а в дозуванні не впевнені.',
    text: 'Протоколи оновлюються щокварталу, взаємодія препаратів — складна. Одна помилка в призначенні — і наслідки одразу.',
  },
  {
    id: 'pain-3',
    icon: 'users',
...
export const baggageContent = {
  ...
  text: 'Це не просто промпти. Це інструментарій: який ШІ-інструмент обрати для якої задачі, як налаштувати пам\'ять і загальну інструкцію щоб ШІ не галюцинував, як перевіряти відповіді через рефлексію — і так, готові промпти теж. Але промпт без правильного інструменту і налаштування — як рецепт без кухні. Кожне рішення протестоване на реальних клінічних випадках сімейним лікарем із 13 роками практики.',
};

export const pricingContent = {
  sectionTitle: '799₴ — одноразова покупка',
  timeSaving: 'Диф. діагноз з джерелами — за 3 хвилини. Дозування по протоколу — за хвилину.',
  urgency: '799₴ — вступна ціна до 2 березня. Потім — 1 299₴.',
  price: '799 ₴',
  priceEuro: '€19',
  subtitle: 'Одноразова покупка — менше сумнівів з першого дня.',
  features: [
...
export const courseFaqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Ні. Більшість рішень працюють з безкоштовними ШІ-інструментами. Ми показуємо різні варіанти для кожної задачі — ви обираєте що підходить.',
  },
  {
    id: 'cfaq-6',
