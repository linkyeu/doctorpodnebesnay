// WayForPay payment link (product: "AI-інструменти для лікарів", 999₴)
...
export const heroContent = {
  title: 'Впевненіше на кожному прийомі —<br>навіть коли відповідь не очевидна',
  subtitle:
    'Онлайн-довідник з готовими ШІ-рішеннями для лікарів.<br>Діагностика, протоколи, документація — відкрий і працюй.',
  sourceNote: '',
  productLine: 'ВІДЕО-ІНСТРУКЦІЇ + TELEGRAM ПІДТРИМКА',
...
export const painPoints: PainPoint[] = [
  {
    ...
    text: 'Гайдлайни змінюються постійно — МОЗ, CDC та інші доказові джерела.',
  },
  {
    id: 'pain-2',
    icon: 'alert',
    headline: 'Складний випадок — а спитати нікого прямо зараз.',
    text: 'Колега зайнятий, завідувач на нараді. Рішення треба прийняти зараз — а впевненості нема.',
  },
  {
    id: 'pain-3',
    icon: 'users',
    headline: '«А ChatGPT сказав інше!» — чуєте це все частіше.',
    text: 'Пацієнти приходять з «діагнозами» від ChatGPT і вимагають пояснень.',
  },
];
