...
export const whatsInsideHeading = 'Від діагнозу до виписки — за хвилини';
...
export const whatsInsideTasks: WhatsInsideTask[] = [
  ...
  },
  {
    ...
    result: 'Готова виписка за структурою вашої клініки',
  },
  {
    id: 'task-updates',
    image: '/images/ai-course/whats-inside/updates.webp',
    task: 'Оновлення протоколів',
    result: 'ШІ моніторить зміни — ви завжди в курсі',
  },
];
...
export const beforeAfterExample = {
  ...
  before: {
    label: 'Без довідника',
    text: 'Ви питаєте ChatGPT — і отримуєте «250 мг 3 рази на день». Без ваги. Без джерела. Без альтернативи для алергіків. Гуглите, перераховуєте, сумніваєтесь — 20 хвилин.',
  },
  after: {
    label: 'З довідником',
    ...
    result: 'Точне дозування за вагою, альтернатива при алергії, посилання на настанову МОЗ. Перевіряєте і призначаєте — 3 хвилини.',
  },
  footer: '',
};
...
export const heroContent = {
  ...
  subtitle:
    'Від сумніву в дозуванні до перевіреної відповіді за хвилину. <br>Довідник покаже, як використовувати ШІ у лікарській практиці. <br>Покроково.',
...
export const painPoints: PainPoint[] = [
  {
    id: 'pain-1',
    icon: 'brain',
    headline: 'Протоколи оновились — а ви дізнались постфактум.',
    text: 'Настанови МОЗ змінюються щокварталу. Ви призначаєте за старою схемою — і дізнаєтесь про зміни від колеги чи на конференції. Або не дізнаєтесь взагалі.',
  },
  {
    id: 'pain-2',
    icon: 'alert',
