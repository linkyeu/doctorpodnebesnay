...
export const heroContent = {
  ...
  subtitle:
    '16 готових ШІ-рішень для щоденної практики лікаря',
  sourceNote: '',
  productLine: 'Діагностика, виписки, протоколи — за хвилини замість годин',
...
export const whatsInsideSubheading = 'Не курс із модулями — 16 готових рішень у 4 блоках. Відкрив, вставив дані пацієнта, отримав відповідь.';
...
export const whatsInsideFeatures = [
  '+ Покрокові інструкції до кожного рішення. Навіть якщо ти ніколи не користувався ChatGPT — відкриєш і зрозумієш.',
...
export const authorTrustTechBadge = '⚙️ Технічна частина: Деніс Філіппов, ШІ-інженер IBM (12+ років) — промпти, захист від галюцинацій, перевірка точності';
...
export const pricingContent = {
  ...
  features: [
    'Доступ назавжди — купуєте один раз',
